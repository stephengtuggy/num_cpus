#!/usr/bin/env sh
##
# num_cpus.sh - A cross-platform shell script to determine the number of logical processors currently online and available
#
...
#
# All retrieved 2026-03-12. All licensed under CC BY-SA 3.0
#
